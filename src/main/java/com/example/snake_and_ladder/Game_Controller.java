...
//        fadeIn.setNode(freeCoins);
//        fadeIn.setToValue(1);
//        freeCoins.setOnMouseEntered(e -> fadeIn.playFromStart());
//
//        final FadeTransition fadeOut = new FadeTransition(Duration.millis(100));
//        fadeOut.setNode(freeCoins);
//        fadeOut.setToValue(0.5);
//        freeCoins.setOnMouseExited(e -> fadeOut.playFromStart());
//
//        freeCoins.setOpacity(0.5);
   ...
   public  static void goBackToMenu () throws IOException {
    ...
    public  void goToLocalMultiplayer() throws IOException {
        ...
        Scene scene = new Scene(grid.createGrid(), 1020.0, 960.0, Color.BISQUE);
